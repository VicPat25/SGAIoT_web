        ...
        <div class="row">
          ...
          <div class="col-6">
            ...
            <div v-if="widgetType == 'numberchart'">
              ...
              <base-input v-model="ncConfig.icon" label="Icon" type="text"></base-input>
              ...
              <el-select v-model="ncConfig.column" class="select-success" placeholder="Select Column Width"
                style="width: 100%;">
            ...
            <div v-if="widgetType == 'switch'">
              ...
              <base-input v-model="iotSwitchConfig.icon" label="Icon" type="text"></base-input>
            ...
            <div v-if="widgetType == 'button'">
              ...
              <base-input v-model="configButton.icon" label="Icon" type="text"></base-input>
          ...
          <!-- WIDGET PREVIEW -->
          <div class="col-6">
            <Rtnumberchart v-if="widgetType == 'numberchart'" :config="ncConfig"></Rtnumberchart>
            <Iotswitch v-if="widgetType == 'switch'" :config="iotSwitchConfig"></Iotswitch>
            <Iotbutton v-if="widgetType == 'button'" :config="configButton"></Iotbutton>
            <Iotindicator v-if="widgetType == 'indicator'" :config="iotIndicatorConfig"></Iotindicator>
          </div>
        </div>
